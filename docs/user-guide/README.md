...
| إصدار الدليل    | **HEAD = origin/main = Production = b5f60c2** (بعد نشر إصلاح الطباعة + بذر QA؛ بدء الإغلاق كان f52828c) |
...
**طباعة ميزان المراجعة:** **PASS** بعد نشر b5f60c2 (لقطة 19). كان FAIL على f52828c بسبب `sessionStorage`.
...
| `qa-purchasing@oms.haseb.org`    | مشتريات                                             | **نشط** بعد b5f60c2        |
| `qa-investors@oms.haseb.org`     | مستثمرون                                            | **نشط** بعد b5f60c2        |
| `qa-hr@oms.haseb.org`            | موارد بشرية                                         | **نشط** بعد b5f60c2        |
