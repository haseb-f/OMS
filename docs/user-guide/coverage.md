...
| تقارير: طباعة قائمة                        | **FAIL** على f52828c             | sessionStorage/opener → إصلاح `print-bridge.ts` بانتظار نشر |
...
| qa-purchasing / qa-investors / qa-hr    | في `ensure-qa-users.ts` — **PENDING** نشر/بذر |
| qa-finance + sales.refunds.*            | في السكربت — PENDING إعادة بذر                |
