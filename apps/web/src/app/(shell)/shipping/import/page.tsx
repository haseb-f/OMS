...
function ShippingImportContent() {
  const { t } = useLocale();
  ...
  return (
    <div className="flex flex-col gap-6">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink href="/shipping">{t("shipping.title")}</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>{t("nav.storeOrdersShippingImport")}</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <PageHeader
        ...
        subtitle={t("shipping.import.description")}
        actions={
          typeDef ? (
            <EnterpriseButton
              type="button"
      ...
      {!typeDef ? (
        ...
        <EnterpriseDataTable
          tableId="shipping-import-jobs"
          printTitle={t("nav.storeOrdersShippingImport")}
          columns={columns}
          data={jobs}
