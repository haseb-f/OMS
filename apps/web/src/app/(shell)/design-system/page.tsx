    ...
    <div className="flex flex-col gap-10 pb-16">
      ...
      <Section title={t("designSystem.buttons")}>
        <EnterpriseCard>
          <EnterpriseCardContent className="flex flex-wrap items-center gap-3">
            ...
            <EnterpriseButton variant="outline">{t("designSystem.outlineButton")}</EnterpriseButton>
      ...
      <Section title={t("designSystem.cards")}>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <KpiCard icon={ShoppingCart} label="KPI Label" value={128} tone="green" />
        </div>
      </Section>
        ...
        <EnterpriseCard>
          <EnterpriseCardContent>
            <EmptyState
              ...
              action={
                <EnterpriseButton size="sm">{t("designSystem.emptyStateAction")}</EnterpriseButton>
              }
            />
          </EnterpriseCardContent>
        </EnterpriseCard>
