...
export const navigationConfig: NavigationItem[] = [
  ...
  {
    id: "hr-kpi-templates",
    titleKey: "nav.hrKpiTemplates",
    parent: "hr",
    route: "/hr/kpi-templates",
    icon: "target",
    order: 1,
    permissions: ["hr.kpi-templates.view"],
  },
  {
    id: "hr-kpi-evaluations",
    titleKey: "nav.hrKpiEvaluations",
    parent: "hr",
    route: "/hr/kpi-evaluations",
    icon: "bar-chart",
    order: 2,
    permissions: ["hr.kpi-evaluations.view"],
  },
  {
    id: "hr-sales-targets",
    titleKey: "nav.hrSalesTargets",
    parent: "hr",
    route: "/hr/sales-targets",
    icon: "target",
    order: 3,
    permissions: ["hr.sales-targets.view"],
  },
  {
    id: "hr-ranking",
    titleKey: "nav.hrRanking",
    parent: "hr",
    route: "/hr/ranking",
    icon: "bar-chart",
    order: 4,
  ...
  {
    id: "hr-commission-plans",
    titleKey: "nav.hrCommissionPlans",
    parent: "hr",
    route: "/hr/commission-plans",
    icon: "percent",
    order: 5,
    permissions: ["hr.commission-plans.view"],
  },
  {
    id: "hr-commissions",
    titleKey: "nav.hrCommissions",
    parent: "hr",
    route: "/hr/commissions",
    icon: "percent",
    order: 6,
    permissions: ["hr.commissions.view"],
  },
  {
    id: "hr-payroll",
  ...
  },
  {
    ...
    titleKey: "nav.hrPayrollComponents",
    parent: "hr",
    route: "/hr/payroll-components",
    icon: "calculator",
    order: 8,
    permissions: ["hr.payroll-components.view"],
  },
  ...
  },
  {
    ...
    icon: "building",
    order: 15,
    permissions: ["masterdata.fixed-assets.view"],
  },
  {
    id: "finance-prepaid-expenses",
    titleKey: "nav.financePrepaidExpenses",
    parent: "finance",
    route: "/finance/prepaid-expenses",
    icon: "calendar-clock",
    order: 15.2,
    permissions: ["prepaid-expenses.view"],
  },
  {
    id: "finance-accrued-expenses",
    titleKey: "nav.financeAccruedExpenses",
    parent: "finance",
    route: "/finance/accrued-expenses",
    icon: "wallet",
    order: 15.4,
    permissions: ["accrued-expenses.view"],
  },
  {
    id: "finance-fx",
    titleKey: "nav.financeFx",
    parent: "finance",
