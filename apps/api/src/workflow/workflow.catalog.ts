...
export const INITIAL_WORKFLOW_STATUSES: Array<{
  ...
  },
  {
    ...
    name: 'بانتظار التجهيز',
    nameEn: 'Awaiting Preparation',
    color: 'info',
    sortOrder: 10,
    isSystem: true,
    isFinal: false,
  ...
  // MATCHING — codes mirror BankTransactionMatchStatus 1:1
  {
  ...
  // PAYMENT extras used by Store Order reconciliation
  {
    workflowType: WorkflowType.PAYMENT,
    code: 'OVERPAID',
    name: 'مدفوع زيادة',
